...
// Project card animation on scroll and hover
const cardVariants = {
                        ...
                        >
                            ...
                            <div className="flex gap-6">
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="bg-blue-600 hover:bg-blue-700 transition px-5 py-2 rounded text-white font-semibold shadow-md flex items-center gap-2" style={{ fontFamily: "Signika Negative, sans-serif" }}
                                >
                                    Demo
                                </a>
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="flex items-center gap-2 border border-white hover:border-blue-400 px-5 py-2 rounded font-semibold transition text-white shadow-md" style={{ fontFamily: "Signika Negative, sans-serif" }}
                                >
